<img class="absolute left-0 z-20 bottom-0 pointer-events-none" src="{{ theme_public_asset('images/sign-up/gradient.svg') }}" alt="" />

<div class="flex flex-col justify-center flex-1 px-8 py-16 bg-white z-10">
    <div class="max-w-lg mx-auto">
        <a class="mb-28 inline-block" href="{{ url('') }}">
            <img class="h-10" src="{{ url( get_option("website_logo_brand_dark", asset('img/logo-brand-dark.png')) ) }}" alt="">
        </a>
