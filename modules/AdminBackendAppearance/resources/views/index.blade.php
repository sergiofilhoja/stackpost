                ...
                <div class="row">
                            ...
                            <div class="mb-0">
                                <div class="d-flex gap-4 flex-column flex-lg-row">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="backend_sidebar_type" value="1" id="backend_sidebar_type_1" {{ get_option("backend_sidebar_type", 1)==1?"checked":"" }}>
                                        <label class="form-check-label mt-1" for="backend_sidebar_type_1">
                                            {{ __('Close') }}
                                        </label>
                                    </div>
                                    <div class="form-check me-3">
                                    ...
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="backend_sidebar_type" value="2" id="backend_sidebar_type_2" {{ get_option("backend_sidebar_type", 1)==2?"checked":"" }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-4">
                            ...
                            <input class="form-control" name="backend_site_icon_color" id="backend_site_icon_color" type="text" value="{{ get_option('backend_site_icon_color', '') }}">
                        </div>
                    </div>
                </div>
            </div>
